function createUnityInstance(canvas, config, processFunc) {
  function s(e, t) {
  ...
  processFunc = processFunc || function () {};
  var o,
      l = {
          canvas: canvas,
  ...
  var u = "",
      d = "";
  function h(e) {
      document.webkitCurrentFullScreenElement === canvas ? canvas.style.width && ((u = canvas.style.width), (d = canvas.style.height), (canvas.style.width = "100%"), (canvas.style.height = "100%")) : u && ((canvas.style.width = u), (canvas.style.height = d), (d = u = ""));
  }
  ...
  function P(e, t) {
      if ("symbolsUrl" != e) {
          ...
          processFunc(0.9 * (a ? (a - s - (o ? (i * (o - r)) / o : 0)) / a : 0));
      }
  }
  function x() {
      var e = this;
      ...
      var n,
          ...
          o = t(l[n], {
              ...
              .catch(function (e) {
                  ...
                  "file:" == location.protocol
                      ? s(t + ". Loading web pages via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host Unity content, or use the Unity Build and Run option.", "error")
                      : console.error(t);
              });
  ...
  return (
      (l.SystemInfo = (function () {
          ...
          var d,
              l = { "NT 5.0": "2000", "NT 5.1": "XP", "NT 5.2": "Server 2003", "NT 6.0": "Vista", "NT 6.1": "7", "NT 6.2": "8", "NT 6.3": "8.1", "NT 10.0": "10" }[l] || l,
              h =
                  ((h = document.createElement("canvas")) &&
                      ((d = (f = h.getContext("webgl2")) ? 2 : 0), f || ((f = h && h.getContext("webgl")) && (d = 1)), f && (r = (f.getExtension("WEBGL_debug_renderer_info") && f.getParameter(37446)) || f.getParameter(7937))),
              ...
              (function o() {
                  return void 0 === e
                      ...
                      : e.read().then(function (e) {
                            ...
                            return (
                                h + e.value.length <= d.length ? (d.set(e.value, h), (f = h + e.value.length)) : l.push(e.value),
                                (h += e.value.length),
                                i({ type: "progress", response: a, total: Math.max(u, h), loaded: h, lengthComputable: c, chunk: s ? e.value : null }),
                                o()
                            );
                        });
              })().then(function (e) {
